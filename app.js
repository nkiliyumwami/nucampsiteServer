...
//Routing all requests to https server 
app.all('*', (req, res, next) => {
  //if the connection is secure(https): We are good .. next()
  if(req.secure) {
    return next();
  } else {
    //If the connection is not secure(http) : We redirect all request to https
